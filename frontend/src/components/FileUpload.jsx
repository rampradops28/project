...
//   const handleAnalyze = () => {
//     if (file) {
//       onAnalyze(file, threshold); // ✅ Let parent component handle the API call
//     }
//   };
...
//   const [file, setFile] = useState(null);
//   const [isDragging, setIsDragging] = useState(false);
//   const [threshold, setThreshold] = useState(0.8); // Optional, depending on backend
//   const fileInputRef = useRef(null);
...
//   const handleAnalyze = () => {
//     if (file) {
//       onAnalyze(file, threshold); // You can remove `threshold` if backend doesn't use it anymore
//     }
//   };
